...
Layout:
  ...
  * ``cosmos3_sharding.py`` — Logical-axis to mesh-axis sharding rules
    (``Cosmos3Sharding``, ``Cosmos3ShardingHook``, ``shard_cosmos3_parameters``).
"""

from maxtext.models.cosmos3.cosmos3 import (
    Cosmos3Config,
    Cosmos3MLP,
...
from maxtext.models.cosmos3.cosmos3_sharding import (
    Cosmos3Sharding,
    Cosmos3ShardingHook,
    LogicalAxis,
    MeshAxis,
    ...
    Sharding,
    TensorType,
    shard_cosmos3_parameters,
    sharded_constant_init,
    sharded_init,
)
